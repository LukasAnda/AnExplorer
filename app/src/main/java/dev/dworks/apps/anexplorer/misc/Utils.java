...
public class Utils extends UtilsFlavour{
    ...
    public static void openFeedback(Activity activity){
        sendEmail(activity, "Send Feedback", "Open it! Feedback");
    }
    ...
    public static void sendEmail(Activity activity, String title, String subject){
        ...
        result.putExtra(Intent.EXTRA_EMAIL, new String[]{"openittheapp@gmail.com"});
        result.putExtra(Intent.EXTRA_SUBJECT, subject);
        result.putExtra(Intent.EXTRA_TEXT, "Open it! Feedback"
